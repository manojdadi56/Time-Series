...
# Fill missing values
source_one_tc = data_processing.fill_missing_values(source_one, "TC")
source_two_tc = data_processing.fill_missing_values(source_two, "TC")
sensor_tc = data_processing.fill_missing_values(sensor, "TC")

source_one_hum = data_processing.fill_missing_values(source_one, "HUM")
source_two_hum = data_processing.fill_missing_values(source_two, "HUM")
sensor_hum = data_processing.fill_missing_values(sensor, "HUM")[:8760]

source_one_pre = data_processing.fill_missing_values(source_one, "PRES")
source_two_pre = data_processing.fill_missing_values(source_two, "PRES")
sensor_pre = data_processing.fill_missing_values(sensor, "PRES")[:8760]
